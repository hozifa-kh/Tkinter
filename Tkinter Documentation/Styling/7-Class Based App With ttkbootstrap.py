...
class Menu(ttk.Frame):
    ...
    def create_widgets(self):
        ...
        # create the widgets
        menu_button1 = ttk.Button(self, text = 'Button 1', bootstyle = 'success')
        menu_button2 = ttk.Button(self, text = 'Button 2', bootstyle = 'danger')
        menu_button3 = ttk.Button(self, text = 'Button 3', bootstyle = 'dark')

        menu_slider1 = ttk.Scale(self, orient = 'vertical', bootstyle = 'info')
        menu_slider2 = ttk.Scale(self, orient = 'vertical', bootstyle = 'secondery')

        toggle_frame = ttk.Frame(self)
        menu_toggle1 = ttk.Checkbutton(toggle_frame, text = 'Check 1', bootstyle = 'warning')
...
class Frame(ttk.Frame):
    def __init__(self, parent, label_text, button_text, label_background):
        ...
        # frame widgets
        label = ttk.Label(self, text = label_text, bootstyle = 'danger')
...
App("Class Based App with ttkbootstrap style", (600,600)) 
